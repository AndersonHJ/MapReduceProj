...
dateRanged_filtered_results = FILTER filtered_results BY
        (filtered_valid_flights::Year < 2008 
            OR (2008 == filtered_valid_flights::Year AND 5 >= filtered_valid_flights::Month))
        AND (filtered_valid_flights::Year > 2007 
            OR (filtered_valid_flights::Year == 2007 AND 6 <= filtered_valid_flights::Month))
        and (filtered_valid_flights2::Year < 2008 
            OR (2008 == filtered_valid_flights2::Year AND 5 >= filtered_valid_flights2::Month))
        AND (filtered_valid_flights2::Year > 2007 
            OR (filtered_valid_flights2::Year == 2007 AND 6 <= filtered_valid_flights2::Month));

sum_results = FOREACH dateRanged_filtered_results GENERATE *, filtered_valid_flights::ArrDelayMinutes 
